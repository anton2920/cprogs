...
enum CONTROL_SIGNALS {
    HLT  = 0b10000000000000000,
    MI   = 0b01000000000000000,
    RI   = 0b00100000000000000,
    RO   = 0b00010000000000000,
    II   = 0b00001000000000000,
    IO   = 0b00000100000000000,
    OI   = 0b00000010000000000,
    EO   = 0b00000001000000000,
    EC1  = 0b00000000100000000,
    EC0  = 0b00000000010000000,
    BI   = 0b00000000001000000,
    AI   = 0b00000000000100000,
    AO   = 0b00000000000010000,
    CE   = 0b00000000000001000,
    CO   = 0b00000000000000100,
    JP   = 0b00000000000000010,
...
typedef struct cu {
    uint32_t data[NFLAGS][NINSTR][NSTEPS];
    uint8_t counter;
} cu_t;
